...
import UserAvatar from '../images/user-avatar-dutch.png';
    ...
    <div className="relative inline-flex">
      ...
      >
        ...
        <div className="flex items-center truncate">
          <span className="truncate ml-2 text-sm font-medium text-gray-600 dark:text-gray-100 group-hover:text-gray-800 dark:group-hover:text-white">Learn Dutch Online</span>
      ...
      >
        ...
        >
          <div className="pt-0.5 pb-2 px-3 mb-1 border-b border-gray-200 dark:border-gray-700/60">
            <div className="font-medium text-gray-800 dark:text-gray-100">Learn Dutch Online</div>
