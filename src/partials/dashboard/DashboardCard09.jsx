...
import studyImage from '../../images/study-09.jpg';
import { ClipboardIcon } from '@heroicons/react/24/outline';

function DashboardCard09() {
  const courseLink = 'https://www.learn-dutch-online.com/intermediate-flemish-sessies-overzicht/';
  ...
  return (
    <div className="flex flex-col h-full col-span-full sm:col-span-6 xl:col-span-4 bg-white dark:bg-gray-800 shadow-xs rounded-xl">
      <div className="px-5 pt-5 flex-grow">
        ...
        <Link to="/courses/intermediate-flemish">
          <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-2">Intermediate Flemish</h2>
        </Link>
        {/* Copy button */}
        <button 
        ...
        <div className="flex items-start">
          <div className="text-3xl font-bold text-gray-800 dark:text-gray-100 mr-2">30</div>
