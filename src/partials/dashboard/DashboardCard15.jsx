...
import studyImage from '../../images/study-15.jpg';
  ...
  return (
    <div className="flex flex-col h-full col-span-full sm:col-span-6 xl:col-span-4 bg-white dark:bg-gray-800 shadow-xs rounded-xl">
      <div className="px-5 pt-5 flex-grow">
        ...
        <Link to="/courses/staatsexamen-b2">
          <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-2">Staatsexamen B2</h2>
        </Link>
        </header>
        <div className="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase mb-1">Sessions</div>
        <div className="flex items-start">
          <div className="text-3xl font-bold text-gray-800 dark:text-gray-100 mr-2">8</div>
