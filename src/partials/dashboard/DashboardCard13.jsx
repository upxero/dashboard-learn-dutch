...
import studyImage from '../../images/study-13.jpg';
  ...
  return (
    <div className="flex flex-col h-full col-span-full sm:col-span-6 xl:col-span-4 bg-white dark:bg-gray-800 shadow-xs rounded-xl">
      <div className="px-5 pt-5 flex-grow">
        ...
        <Link to="/courses/inburgering-b1">
          <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-2">Inburgering B1</h2>
        </Link>
        </header>
